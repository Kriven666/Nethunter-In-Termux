# Nethunter-In-Termux (full image)
This is a script by which you can install full version Kali nethunter (Kali Linux) in your termux application without rooted phone 
